...
React.render(
  React.createElement(Parent, {username: "kasi"}),
  document.getElementById("app")
);

},{"./parent.jsx":3,"react":160}],2:[function(require,module,exports){
/** @jsx React.DOM */
    ...
    return (
      React.createElement("div", null, 
        React.createElement("div", {className: "address"}, 
          React.createElement("h1", null, "Address"), 
          React.createElement("p", null, 
            React.createElement("span", null, props.streetNo), 
            React.createElement("span", null, props.streetName)
          ), 
          React.createElement("p", null, props.city), 
          React.createElement("p", null, props.state)
        ), 
        React.createElement("h2", null, returnValue)
      )
    )
  }
});

},{"../test/foo":4,"react":160}],3:[function(require,module,exports){
/** @jsx React.DOM */
...
module.exports = React.createClass({displayName: "exports",
  render: function() {
    ...
    return (
      React.createElement("div", null, 
        React.createElement("h2", null, "Hello ", this.props.username, ", How do you do? "), 
        React.createElement(Child, {address: address})
      )
    )
  }
});

},{"./child.jsx":2,"react":160}],4:[function(require,module,exports){
module.exports = {
  foo: function() {
    return "this is a return value from foo function";
  }
}
